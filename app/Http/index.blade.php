    ...
    <div class="card ">
        <div class="header">
            ...
            <div class="pull-right">
                <a href="#" class="btn btn-success btn-fill" data-toggle="modal" data-target="#operation-modal">Add Category</a>
            </div>
        </div>
        <div class="content">
...
<script>
    $('#edit-modal').on('show.bs.modal', function(e) {
        ...
        $(e.currentTarget).find('[name="type"]').prop('checked', type == 'sub-operation');

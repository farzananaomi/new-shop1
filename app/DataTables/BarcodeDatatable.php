...
class BarcodeDatatable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ...
            ->addColumn('action', function ($stock) {
                return view('barcodes.action', compact('stock'))->render();
            })
    ...
    {
        return [
            ['name' => 'stocks.id', 'data' => 'id', 'title' => 'Stock Id'],
             [ 'name' => 'stocks.barcode_id', 'data' => 'barcode_id', 'title' => 'Barcode' ],
         //   ['name' => 'stocks.buying_price', 'data' => 'buying_price', 'title' => 'Buy Price'],
          ...
          //  ['name' => 'stocks.sub_total', 'data' => 'sub_total', 'title' => 'Sub Total'],
            ['name' => 'stocks.stock_in', 'data' => 'stock_in', 'title' => 'Quantity'],
            ['name' => 'stocks.created_at', 'data' => 'created_at', 'title' => 'Created At'],
